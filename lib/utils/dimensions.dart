class Dimensions {
  ...
  static const double fontSizeExtra2Large = 20.0;
  static const double fontSizeOverLarge = 24.0;
  static const double fontSizeHomeName = 22.0;
  static const double fontSizeOverLargeHeaderAuth = 40.0;

  static const double paddingSizeExtraExtraSmall = 2.0;
  static const double paddingSizeExtraSmall = 5.0;
  static const double paddingSizeMedium = 8.0;
  static const double paddingSizeSmall = 10.0;
  static const double paddingSizeSmallX2 = 12.0;
  ...
  static const double marginSizeExtraLargeX2 = 50.0;
  static const double marginSizeSuperLarge = 30.0;
  static const double marginSizeAuthSmall = 30.0;
  static const double marginSizeOnboardLarge = 40.0;
  static const double marginSizeOnboardSuperLarge = 40.0;
  ...
  static const double iconSizeKindDeafult = 20.0;
